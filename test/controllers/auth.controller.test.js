...
describe("SignUp", () => {
    ...
    it('Should pass and create the user', async () => {
        ...
        expect(res.send).toHaveBeenCalledWith("userCreation successfull..."
    ...
    it('Should return error while user creation', async () => {
        const spy = jest.spyOn(User, 'create').mockImplementation(cb => cb(new Error("error occured in connection"), null))
        const req = mockRequest()
        const res = mockResponse()
        ...
        expect(res.send).toHaveBeenCalledWith(
             "internal error occured in createUser.."
        )
    })
